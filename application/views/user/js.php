...
<?php 
if ($page_name == 'kelola_jadwal' || $page_name == 'kelola_pengguna' || $page_name == 'import_excel' || $page_name == 'kelola_ruangan' || $page_name == 'kelola_ac_detail' || $page_name == 'kelola_ac_pakai') { ?>
  <script src="<?php echo base_url().'/'; ?>bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
  <script src="<?php echo base_url().'/'; ?>bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
  <!-- test -->

  <script src="<?php echo base_url().'/'; ?>dist/js/jquery-latest.js"></script>

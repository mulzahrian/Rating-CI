...
<section class="content">
	<div class="row">
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php echo form_open('admin/add_pesanan', array('class' => 'form-horizontal')) ?>
							<div class="box-body">
					...
					<tbody>
						...
						foreach($data_gsg as $list){
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit<?php echo $list->formulir_id; ?>" id="sa-params">Edit</button>
										<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
											<span class="caret"></span>
											<span class="sr-only">Toggle Dropdown</span>
										</button>
										<ul class="dropdown-menu" role="menu">
											<li><a href="<?php echo base_url();?>admin/detail_gsg/<?php echo $list->formulir_id; ?>">Detail</a></li>
											<li><a href="<?php echo base_url();?>admin/cetak_gsg/<?php echo $list->formulir_id; ?>">Cetak</a></li>
											<li><a href="#" data-toggle="modal" data-target="#modal-batal<?php echo $list->formulir_id; ?>" id="sa-params">Batal</a></li>
											<li><a href="#" data-toggle="modal" data-target="#modal-delete<?php echo $list->formulir_id; ?>" id="sa-params">Hapus</a></li>
										</ul>
									</div>
									<!-- <button class="btn btn-warning" data-toggle="modal" data-target="#modal-edit<?php echo $list->formulir_id; ?>" id="sa-params"><i class="fa fa-edit"></i></button> -->
									<!-- <button class="btn btn-danger" data-toggle="modal" data-target="#modal-delete<?php echo $list->formulir_id; ?>" id="sa-params"><i class="fa fa-trash"></i></button> -->
									<!-- <button class="btn btn-info" data-toggle="modal" data-target="#modal-detail<?php echo $list->formulir_id; ?>" id="sa-params"><i class="fa fa-file-text"></i></button> -->
									<!-- <button class="btn btn-primary" data-toggle="modal" data-target="#modal-cetak<?php echo $list->formulir_id; ?>" id="sa-params"><i class="fa fa-print"></i></button> -->
									<!-- <div class="btn-group">
									...
									<!-- <a href="<?php echo base_url();?>admin/detail_gsg/<?php echo $list->formulir_id; ?>" class="btn btn-info"><i class="fa fa-file-text"></i></a> -->
								</td>
							</tr> 
			...
			<div class="modal fade" id="modal-delete<?php echo $list->formulir_id; ?>">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php echo form_open('admin/delete_gsg', array('class' => 'form-horizontal')) ?>
							<div class="box-body">
								<center>
		...
		<!-- modal batal -->
		<?php foreach($data_gsg as $list){ ?>
			<div class="modal fade" id="modal-batal<?php echo $list->formulir_id; ?>">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">

						<div class="modal-body">
							<?php echo form_open('admin/batal_gsg', array('class' => 'form-horizontal')) ?>
							<div class="box-body">
								<center>
									<img src="<?php echo base_url().'/'; ?>dist/img/non.png" width="30%">
									<h4>Apakah anda ingin membatalkan pesanan ini ?</h4>
								</center>
								<input type="hidden" name="formulir_id" value="<?php echo $list->formulir_id;?>">
							</div>
							<div class="modal-footer">
			...
			<div class="modal fade" id="modal-edit<?php echo $list->formulir_id; ?>">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php echo form_open('admin/edit_pesanan', array('class' => 'form-horizontal')) ?>
							<div class="box-body">
								<div class="form-group">
									<label class="col-sm-2 control-label">Tanggal Pemakaian</label>
									<div class="col-sm-5">
